            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <div class="container">
                     <div class="carousel-caption">
                        <div class="text-bg">
                           <figure><img src="images/header1.jpg" alt="#"/></figure>
                        </div>
                     </div>
                  </div>
               </div>
               <div class="carousel-item">
                  <div class="container">
                     <div class="carousel-caption">
                        <div class="text-bg">
                           <figure><img src="images/header2.png" alt="#"/></figure>
                        </div>
                     </div>
                  </div>
               </div>
               <div class="carousel-item">
                  <div class="container">
                     <div class="carousel-caption">
                        <div class="text-bg">
                           <figure><img src="images/header3.jpeg" alt="#"/></figure>
                        </div>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <a href="<%=menu.getHref() %>">
                  <div class="glasses_box">
                     <figure><img src="<%=menu.getImageUrl() %>" alt="#" width="100px" height="100px"/></figure>
                     <h3><span class="blu"></span><%=menu.getName() %></h3>
                  </div>
                </a>
               </div>
             <%
